...
for i in configuration:
    ...
    for j in range(len(num_range)):
        ...
        data_1 = np.loadtxt(after_path + 'num_%d_10000.txt' % num_range[j])
        data_2 = np.loadtxt(after_path + 'num_%d_20000.txt' % num_range[j])
        data_3 = np.loadtxt(after_path + 'num_%d_30000.txt' % num_range[j])
        data_4 = np.loadtxt(after_path + 'num_%d_40000.txt' % num_range[j])
        data_5 = np.loadtxt(after_path + 'num_%d_50000.txt' % num_range[j])
        data_6 = np.loadtxt(after_path + 'num_%d_60000.txt' % num_range[j])
        data_7 = np.loadtxt(after_path + 'num_%d_70000.txt' % num_range[j])
        data_8 = np.loadtxt(after_path + 'num_%d_80000.txt' % num_range[j])
        data_9 = np.loadtxt(after_path + 'num_%d_90000.txt' % num_range[j])
        data_10 = np.loadtxt(after_path + 'num_%d_100000.txt' % num_range[j])
        ...
        index_1 = np.loadtxt(index_path + 'num_%d_10000_flag.txt' % num_range[j])
        index_2 = np.loadtxt(index_path + 'num_%d_20000_flag.txt' % num_range[j])
        index_3 = np.loadtxt(index_path + 'num_%d_30000_flag.txt' % num_range[j])
        index_4 = np.loadtxt(index_path + 'num_%d_40000_flag.txt' % num_range[j])
        index_5 = np.loadtxt(index_path + 'num_%d_50000_flag.txt' % num_range[j])
        index_6 = np.loadtxt(index_path + 'num_%d_60000_flag.txt' % num_range[j])
        index_7 = np.loadtxt(index_path + 'num_%d_70000_flag.txt' % num_range[j])
        index_8 = np.loadtxt(index_path + 'num_%d_80000_flag.txt' % num_range[j])
        index_9 = np.loadtxt(index_path + 'num_%d_90000_flag.txt' % num_range[j])
        index_10 = np.loadtxt(index_path + 'num_%d_100000_flag.txt' % num_range[j])
        ...
        index = np.concatenate((index_1, index_2, index_3, index_4, index_5, index_6, index_7, index_8, index_9, index_10), axis=0)
