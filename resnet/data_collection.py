...
if __name__ == '__main__':
    ...
    for epoch in range(startnum,endnum):
        ...
        cv2.imwrite(os.path.join(data_root, 'input/close_409_img/img%s.png') % epoch, img)

        np.savetxt(os.path.join(data_root, "label/close_409_label/close_409_%d.csv" % epoch), label)
