            ...
            if self.real_operate == True:
                ...
                while True:
                    ...
                    while True:
                        ...
                        break_flag = abs(seg_pos[0] - tar_pos[0]) < 0.001 and abs(seg_pos[1] - tar_pos[1]) < 0.001 and abs(seg_pos[2] - tar_pos[2]) < 0.001 and \
                                abs(seg_ori[0] - tar_ori[0]) < 0.001 and abs(seg_ori[1] - tar_ori[1]) < 0.001 and abs(seg_ori[2] - tar_ori[2]) < 0.001
                        if break_flag:
                            break
                    ...
                    cur_pos = real_xyz[-1]
                    if abs(seg_pos[0] - cur_pos[0]) < 0.001 and abs(seg_pos[1] - cur_pos[1]) < 0.001 and abs(seg_pos[2] - cur_pos[2]) < 0.001:
                        seg_flag = True
                        break
                    elif seg_time > 3:
                        seg_flag = False
